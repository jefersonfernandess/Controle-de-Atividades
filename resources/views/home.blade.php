                ...
                <ul class="navbar-nav mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                          <li><a class="dropdown-item" href="#">Adicionar atividade</a></li>
                          <li><a class="dropdown-item" href="#">Adicionar aluno(a)</a></li>
                          <li><a class="dropdown-item" href="#">Adicionar professor(a)</a></li>
